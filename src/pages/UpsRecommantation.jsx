  ...
  return (
    <>
        ...
        <div className="ups_right_child">
          ...
          <div className="recommantation_margin_child">
            ...
            <div className="recommantation_header_list_left">
              <div
                className={lastPart === "shortlisted_UpsRecommantation" ? "changeColor" : ""}
              >
                <input type="checkbox" onChange={() => navigate("/shortlisted_UpsRecommantation")} />
                <label>USP’s</label>
              </div>
              <div
                className={
                  lastPart === "shortlisted_FacilitiyRecommantaion" ? "changeColor" : ""
                }
              >
                <input
                  type="checkbox"
                  onChange={() => navigate("/shortlisted_FacilitiyRecommantaion")}
                />
                <label>Facilities</label>
              </div>
              <div
                className={
                  lastPart === "shortlisted_PlacementRecommantation" ? "changeColor" : ""
                }
              >
                <input
                  type="checkbox"
                  onChange={() => navigate("/shortlisted_PlacementRecommantation")}
                />
      ...
      <div className="recommantation_right_div">
          ...
          <div className="recommantation_Ups_data">
...
export default UpsRecommantation;
