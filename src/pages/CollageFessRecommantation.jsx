...
const CollageFessRecommantation = () => {
                ...
                <tbody>
                  <tr>
                    ...
                    <div className='table_center_div'>
                                    <p>B.tech Mechanical Engineering</p>     <p>CAF Amount: INR 10,000</p>
                     </div>
                    </td>
                    <td>INR 35k/yr</td>
                    <td>4 Year</td>
                    <td><button className='button_recommantation_table' >
                    Mark
                </button></td>
                  </tr>
                  <tr>
...
export default CollageFessRecommantation;
